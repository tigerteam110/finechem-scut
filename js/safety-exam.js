 ...
 * 华南理工大学化学与化工学院 · 精细化工团队（16#110）实验室安全与良好行为习惯考核系统
 * 
 * 考卷规则：
 * - 考生必须输入：姓名、学号
 * - 共 20 道日常行为规范与安全习惯题目（单选/判断题）
 * - 每题 5 分，满分 100 分
  ...
  zh: [
    {
      ...
      answer: "A",
      citation: "《16#110 实验室安全习惯建议》第9页、第17页；《高等学校实验室安全检查项目表》第6.3.7条",
    ...
    },
    {
      ...
      answer: "B",
      citation: "《16#110 实验室安全习惯建议》第9页、第18页；《高等学校实验室安全检查项目表》第6.3.7条",
      explanation: "规范第6.3.7条明确要求：通风橱内应避免放置过多器材，物品应距离门内侧15cm以上。16#110守则特别强调，通风橱内严禁放置塑料薄膜、纸巾、塑料杯等轻质物品，高速气流极易将其吸入排气主管道或风机叶轮，导致电机堵转烧毁并诱发火灾。"
    },
    {
      id: 3,
      type: "judge",
      ...
      answer: "A",
      citation: "《16#110 实验室安全习惯建议》第7页、第17页、第23页；《高等学校实验室安全检查项目表》第11.2.5条",
    ...
    },
    {
      ...
      answer: "B",
      citation: "《16#110 实验室安全习惯建议》第11页；《高等学校实验室安全检查项目表》第8.7.6条",
      explanation: "《高等学校实验室安全检查项目表》第8.7.6条严禁向下水道倾倒废液。16#110配备有酸类、醇类、酯类、苯类专用废液桶（514A还配备卤代烃和酮类桶）。直排废液会腐蚀下水管网并释放剧毒挥发物，甚至因管内化学混合发生燃爆，必须分类归桶处置。"
    },
    {
      id: 5,
      type: "judge",
      ...
      answer: "A",
      citation: "《16#110 实验室安全习惯建议》第8页、第11页；《高等学校实验室安全检查项目表》第8.9.6条",
    ...
    },
    {
      ...
      answer: "B",
      citation: "《16#110 实验室安全习惯建议》第2页、第19页；《高等学校实验室安全检查项目表》第5.3.2条",
      explanation: "16#110规范强调：不用的废弃手套口罩随手扔进垃圾桶，若还要使用建议装入自封袋自己保管，严禁随意抛弃在公共实验区域。遗留在台面不仅脏乱，还会导致不知情的他人接触手套残留危化品造成接触性灼伤与交叉污染。"
    },
    {
      id: 7,
      type: "judge",
      question: "16#110 实验室核心环境大原则是：“用完后保持实验室前后状况卫生一致，物品归位擦净台面，让后来人看不出有人来做过实验”？",
      options: [
        { key: "A", text: "正确（核心原则）。每个人自觉做好物品归位与台面保洁，是实验室安全运行的基石" },
        { key: "B", text: "错误。搞卫生是值日生一个人的事，做实验的人做完就走不需要收拾" }
      ],
      answer: "A",
      citation: "《16#110 实验室安全习惯建议》大原则第一条；《高等学校实验室安全检查项目表》第5.3.2条",
      explanation: "16#110实验室首要大原则：当事人用完实验室后要保持实验室前后状况卫生一致（至少做到物品归位，抹干净桌面），达到让后来人看不出有人做过实验的整洁标准。公共安全建立在每位科研人员严谨自律的基础之上。"
    },
    {
      id: 8,
      type: "judge",
      question: "为节约耗材或图方便，是否可以使用喝空的农夫山泉、茶饮料瓶来分装盛放实验试剂或自制化学溶液？",
      options: [
        { key: "A", text: "可以。只要用马克笔在饮料瓶上写个化学式就可以安全存放" },
        { key: "B", text: "绝对严禁（错误）。禁止使用饮料瓶盛放试剂，极易导致误饮引发恶性中毒事故" }
      ],
      answer: "B",
      citation: "《16#110 实验室安全习惯建议》第7页；《高等学校实验室安全检查项目表》第8.9.4条",
      explanation: "高校安全规范第8.9.4条明文规定：严禁使用饮料瓶存放试剂、样品及实验废液。饮料瓶外观具有极强欺骗性，极易被实验人员或保洁人员误当作饮料误饮，造成不可逆的消化道化学灼伤甚至危及生命！若用专用瓶盛放，必须撕去原有纸质标签并贴上规范试剂标签。"
    },
    {
      id: 9,
      type: "single",
      question: "在 16#110 实验室盛放配制的试剂、合成乳液或反应中间体等容器（烧杯、烧瓶、离心管），规范的要求是：",
      options: [
      ...
      answer: "B",
      citation: "《16#110 实验室安全习惯建议》第3页、第12页；《高等学校实验室安全检查项目表》第8.9.3条",
      explanation: "规范第8.9.3条要求：盛放试剂、合成品的烧杯和烧瓶不得无盖放置，标签信息必须明确完整。16#110守则特别强调：自己的样品若必须置于公共区域，须用胶布贴牢，用标签写好姓名和时间，既防值日生清理时误判污染，又能在发生异常时第一时间精准联系主人。"
    },
    {
      id: 10,
      type: "single",
      ...
      answer: "C",
      citation: "《16#110 实验室安全习惯建议》第4页、第15页、第24页；《高等学校实验室安全检查项目表》第7.1.4条",
      explanation: "第7.1.4条明文规定：禁止多个接线板串接供电，接线板不宜直接置于地面（防止实验水流渗漏触电短路）。16#110特别提醒：接线板绝不能放在密闭抽屉里，密闭空间散热极差，长时间积热会导致插头自燃起火；通风橱底板易积聚冷凝水和试剂，严禁在通风橱底板放置排插。"
    },
    {
      id: 11,
      type: "single",
      ...
      answer: "B",
      citation: "《16#110 实验室安全习惯建议》第13页、第14页、第22页；《高等学校实验室安全检查项目表》第12.5.7条",
    ...
    },
    {
      ...
      answer: "A",
      citation: "《16#110 实验室安全习惯建议》第14页、第19页；《高等学校实验室安全检查项目表》第12.6.4条",
    ...
    },
    {
      ...
      answer: "B",
      citation: "《16#110 实验室安全习惯建议》第10页；《高等学校实验室安全检查项目表》第7.3.1条、第11.2.1条",
    ...
    },
    {
      ...
      answer: "B",
      citation: "《16#110 实验室安全习惯建议》第10页；《高等学校实验室安全检查项目表》第7.3.4条",
    ...
    },
    {
      ...
      answer: "A",
      citation: "《16#110 实验室安全习惯建议》第4页、第11页；《高等学校实验室安全检查项目表》第5.3.3条、第7.4.2条",
    ...
    },
    {
      ...
      answer: "A",
      citation: "《16#110 实验室安全习惯建议》第7页；《高等学校实验室安全检查项目表》第8.5.2条",
    ...
    },
    {
      ...
      answer: "C",
      citation: "《16#110 实验室安全习惯建议》第8页；《高等学校实验室安全检查项目表》第12.4.1条",
    ...
    },
    {
      ...
      answer: "A",
      citation: "《16#110 实验室安全习惯建议》第16页、第20页；《高等学校实验室安全检查项目表》第5.3.2条",
      explanation: "16#110规范指引：电子天平用完必须擦拭干净、合上防风罩盖子。化学粉末具有吸湿腐蚀性，遗撒在天平盘内会腐蚀精密的称重传感器导致精度报废；防风罩不关易引起气流吹落积尘损坏内部机械结构。"
    },
    {
      id: 20,
      type: "single",
      question: "依据 16#110 实验室值日与安全台账管理制度，下列关于值日生职责的描述完全正确的是：",
      options: [
      ...
      answer: "A",
      citation: "《16#110 实验室安全习惯建议》大原则第二、三条及第5页、第6页",
      explanation: "16#110明确规定：值日生交接前至少必须拖地一次并倒干净垃圾；日常检查记录本与安全卫生台账双人协同负责（一个打扫，一个检查督促填写），真实反映实验室安全环境状况，严禁造假应付，确保隐患及时发现并闭环清零。"
    }
  ],
  en: [
    {
      ...
      answer: "A",
      citation: "Laboratory 16#110 Habit Guidelines, pages 9 and 17; Safety Check Inspection Item 6.3.7.",
    ...
    },
    {
      ...
      answer: "B",
      citation: "Laboratory 16#110 Habit Guidelines, pages 9 and 18; Safety Check Inspection Item 6.3.7.",
    ...
    },
    {
      ...
      answer: "A",
      citation: "Laboratory 16#110 Habit Guidelines, pages 7, 17, and 23; Safety Check Inspection Item 11.2.5.",
    ...
    },
    {
      ...
      answer: "B",
      citation: "Laboratory 16#110 Habit Guidelines, page 11; Safety Check Inspection Item 8.7.6.",
      explanation: "Item 8.7.6 strictly prohibits discharging chemical waste down drains. Room 16#110 maintains dedicated carboys for acids, alcohols, esters, and aromatics, with halogenated and ketone containers in Room 514A. Drainage corrodes pipes, pollutes water systems, and risks exothermic gas release in sewer lines."
    },
    {
      id: 5,
      type: "judge",
      ...
      answer: "A",
      citation: "Laboratory 16#110 Habit Guidelines, pages 8 and 11; Safety Check Inspection Item 8.9.6.",
    ...
    },
    {
      ...
      answer: "B",
      citation: "Laboratory 16#110 Habit Guidelines, pages 2 and 19; Safety Check Inspection Item 5.3.2.",
      explanation: "Room 16#110 guidelines require discarded consumables to be thrown into waste receptacles right after use. Items intended for reuse must be stored in clean individual ziplock bags. Leaving contaminated gloves on shared benches exposes coworkers to chemical contact burns and sample cross-contamination."
    },
    {
      id: 7,
      type: "judge",
      question: "Is the core cleanliness principle of Room 16#110: 'Maintain consistent sanitation before and after work, return items, wipe benches, so successors cannot tell experiments occurred'?",
      options: [
      ...
      answer: "A",
      citation: "Laboratory 16#110 Habit Guidelines, Principle 1; Safety Check Inspection Item 5.3.2.",
      explanation: "Principle 1 of Room 16#110 requires experimenters to keep identical bench hygiene before and after experiments, returning tools and wiping counters spotless. Mutual civic courtesy and daily self-discipline constitute the frontline of lab safety."
    },
    {
      id: 8,
      type: "judge",
      question: "Is it acceptable to repurpose empty mineral water or iced tea bottles to hold chemical reagents, stock solutions, or intermediate reaction mixtures?",
      options: [
        { key: "A", text: "Acceptable. Marking the chemical formula on the bottle with a felt marker makes it safe." },
        { key: "B", text: "Strictly Prohibited (Required). Commercial beverage containers must never hold chemicals to prevent accidental ingestion." }
      ],
      answer: "B",
      citation: "Laboratory 16#110 Habit Guidelines, page 7; Safety Check Inspection Item 8.9.4.",
      explanation: "Regulation item 8.9.4 forbids using commercial beverage containers for reagents, samples, or waste solutions. Beverage bottles create deceptive impressions, inviting fatal ingestion accidents by students or cleaning staff. Reagent vessels must be proper lab bottles with standardized chemical labels."
    },
    {
      id: 9,
      type: "single",
      question: "What is the mandatory protocol for beakers, flasks, and centrifuge tubes holding prepared reagents or emulsion products in Room 16#110?",
      options: [
      ...
      answer: "B",
      citation: "Laboratory 16#110 Habit Guidelines, pages 3 and 12; Safety Check Inspection Item 8.9.3.",
      explanation: "Item 8.9.3 mandates that reagent containers must never sit unsealed, and labeling must be clear and complete. Room 16#110 guidelines specify that samples placed in shared areas must carry tape labels with the researcher's name and time period, preventing accidental disposal and easing emergency tracing."
    },
    {
      id: 10,
      type: "single",
      ...
      answer: "C",
      citation: "Laboratory 16#110 Habit Guidelines, pages 4, 15, and 24; Safety Check Inspection Item 7.1.4.",
      explanation: "Item 7.1.4 strictly forbids daisy-chaining power strips and warns against placing them directly on wet floor areas. Room 16#110 rules highlight that power strips inside wooden drawers trap heat and induce fires, while fume hood baseplates accumulate spills and condensation, making power strips unsafe there."
    },
    {
      id: 11,
      type: "single",
      ...
      answer: "B",
      citation: "Laboratory 16#110 Habit Guidelines, pages 13, 14, and 22; Safety Check Inspection Item 12.5.7.",
    ...
    },
    {
      ...
      answer: "A",
      citation: "Laboratory 16#110 Habit Guidelines, pages 14 and 19; Safety Check Inspection Item 12.6.4.",
    ...
    },
    {
      ...
      answer: "B",
      citation: "Laboratory 16#110 Habit Guidelines, page 10; Safety Check Inspection Item 11.2.1.",
    ...
    },
    {
      id: 14,
      type: "single",
      question: "Which of the following apparel meets laboratory personal protective equipment (PPE) criteria when working in Room 16#110?",
      options: [
      ...
      answer: "B",
      citation: "Laboratory 16#110 Habit Guidelines, page 10; Safety Check Inspection Items 7.3.1 and 11.2.1.",
    ...
    },
    {
      ...
      answer: "B",
      citation: "Laboratory 16#110 Habit Guidelines, page 10; Safety Check Inspection Item 7.3.4.",
    ...
    },
    {
      ...
      answer: "A",
      citation: "Laboratory 16#110 Habit Guidelines, pages 4 and 11; Safety Check Inspection Items 5.3.3 and 7.4.2.",
    ...
    },
    {
      ...
      answer: "A",
      citation: "Laboratory 16#110 Habit Guidelines, page 7; Safety Check Inspection Item 8.5.2.",
    ...
    },
    {
      ...
      answer: "C",
      citation: "Laboratory 16#110 Habit Guidelines, page 8; Safety Check Inspection Item 12.4.1.",
    ...
    },
    {
      ...
      answer: "A",
      citation: "Laboratory 16#110 Habit Guidelines, pages 16 and 20; Safety Check Inspection Item 5.3.2.",
      explanation: "Room 16#110 rules dictate that analytical balances must be brushed clean and shielded after every use. Hygroscopic and corrosive powders attack delicate electromagnetic sensors, and unclosed draft shields expose precision knives to air drafts and ambient dust."
    },
    {
      id: 20,
      type: "single",
      question: "According to the duty roster and ledger protocols of Room 16#110, which statement accurately reflects student obligations?",
      options: [
      ...
      answer: "A",
      citation: "Laboratory 16#110 Habit Guidelines, Principles 2 and 3, plus pages 5 and 6.",
      explanation: "Room 16#110 mandates that duty personnel mop floors and empty garbage cans before shift handover. Two students collaborate as cleaning duty and safety inspector, recording real observations and avoiding fabricated entries to maintain lab hygiene."
    }
  ]
};
  ...
  submitExam() {
    ...
    if (answeredCount < totalCount) {
      const msg = this.currentLang === 'en' 
        ? `You have answered ${answeredCount} of ${totalCount} questions. Please answer all 20 questions before submitting.`
      ...
      html += `
        <div class="${cardClass}" id="question_block_${q.id}">
          <div class="question-header">
            ...
            <span class="question-points">${this.currentLang === 'en' ? '5 pts' : '5分'}</span>
            ${this.submitted ? (isCorrect 
                ? `<span class="verdict-tag verdict-pass"><i class="fas fa-check-circle"></i> ${this.currentLang === 'en' ? 'Correct (+5)' : '回答正确 (+5)'}</span>`
    ...
    if (isPass) {
      ...
      html = `
        <div class="exam-result-summary pass">
          ...
          <p class="result-lead">${this.currentLang === 'en' 
            ? 'You have successfully answered all 20 safety habit questions correctly, demonstrating high safety awareness and rigorous laboratory discipline.' 
            : '您已全部答对20道日常行为习惯题目，展现了优良的自觉安全意识与严谨作风，准予进入华南理工大学16#110实验室开展科研工作！'}</p>
          ...
          <div class="cert-preview-card">
            ...
            <div class="cert-body">
              ...
              <p><strong>${this.currentLang === 'en' ? 'Certified Room' : '准入实验室'}：</strong>华南理工大学五山校区 16号楼110室（高分子与胶体材料实验室）</p>
              <p><strong>${this.currentLang === 'en' ? 'Examination Result' : '考核成绩'}：</strong>100 / 100 ${this.currentLang === 'en' ? '(Full Marks, 20/20 Correct)' : '（满分，20题全部正确）'}</p>
      ...
      html = `
        <div class="exam-result-summary fail">
          ...
          <p class="result-lead">${this.currentLang === 'en' 
            ? `You answered ${correctCount} correctly and ${wrongCount} incorrectly. Room 16#110 enforces zero tolerance on basic safety habits. Please review the highlighted wrong answers, study the official regulations, and retake the test.` 
            : `您答对了 ${correctCount} 题，做错了 ${wrongCount} 题。16#110 实验室对日常安全习惯实行零容忍管理。系统已在答卷中逐题标红错误出处与解析，请认真研读后重新考核直至满分通过。`}</p>
